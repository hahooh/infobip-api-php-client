<?php
namespace infobip\api\smsMessage\model\sms\mo\logs;
...
class GetReceivedSmsLogsExecuteContext implements \JsonSerializable
{
    ...
    {
        $this->receivedSince = new \infobip\api\smsMessage\model\FormattedDateTime($receivedSince);
    }
    ...
    {
        $this->receivedUntil = new \infobip\api\smsMessage\model\FormattedDateTime($receivedUntil);
    }
